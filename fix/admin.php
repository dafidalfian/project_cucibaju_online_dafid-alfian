                    ...
                    <div class="x_content">
                      <div class="dashboard-widget-content">
                        <div class="col-md-3 hidden-small">
                          <h2 class="line_30">Paket Cucian</h2>
                        ...
                        <h2 class="line_30">Jenis Cucian</h2>
                          <table class="countries_list">
                            <tbody>
                              <tr>
                                <td>CUCI BASAH</td>
                              ...
                              <tr>
                                <td>CUCI KERING + CUCI SETRIKA</td>
                              </tr>
                            </tbody>
                          </table>
                        </div>
                          
                        <div class="col-md-8 col-sm-12 col-xs-12" > <img src="laundry\1.png" oncontextmenu="return false;" width="780" height="500" class="img-responsive" alt="Responsive image"></div>
                      </div>
                    </div>
                  </div>
          </div>
