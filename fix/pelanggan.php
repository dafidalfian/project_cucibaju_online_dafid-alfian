                      ...
                      <thead>
                       ...
                       <?php
                              ...
                              while ($row=mysql_fetch_array($user)) {
                                ...
                                $alamat = $row['email_user'];
                                $email = $row['email_user'];
                                $foto_ktp = $row['ktp_user'];
                                $foto_profil= $row['profil_user'];
                            ?>
                        <tr>
                          <td><?php echo $no;?></td>
                          ...
                          <?php echo "<td><a class='btn btn-success btn-xs' href='images/".$foto_profil."' role='button'>Lihat Profil</a></td>"; ?>
                          <?php echo "<td><a class='btn btn-success btn-xs' href='images/".$foto_ktp."' role='button'>Lihat KTP</a></td>"; ?>                         
                        </tr>
                        <?php 
                        $no++;
                        }
