        ...
        <div class="right_col" role="main">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <?php
                      $edit = mysql_query("SELECT * FROM tb_admin WHERE id_admin='$id_admin'");
                      $row = mysql_fetch_array($edit);
                    ?>
                    <form class="form-horizontal form-label-left" method="POST" action="proses_edit_admin.php">
                    <input type="hidden" name="id_admin" value=<?php echo $row['id_admin'];?>>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama">Nama <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="nama" class="form-control col-md-7 col-xs-12" name="nama" placeholder="Nama" required="required" type="text" value="<?php echo $row['nama_admin'];?>">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="username" id="username" name="username" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row['username_admin'];?>">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="password" name="password" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row['password_admin'];?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          ...
                          <a class='btn btn-danger' href="admin.php" role='button'><span class='fa fa-close' aria-hidden='true'></span> Batal</a>
                        </div>
                      </div>
                    </form>
                  </div>
